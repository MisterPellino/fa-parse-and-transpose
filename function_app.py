...
app.function_name("http_trigger_fa_parse_and_transpose")
...
def http_trigger_fa_parse_and_transpose(req: func.HttpRequest, excel_table_file: func.InputStream) -> func.HttpResponse:
    ...
    blob_csv = blob_service_client.get_blob_client(container=output_path, blob=output_file)
